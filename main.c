...
int main()
{
    ...
    date_to.year = 2018;
    //printf("%i\n", week_day(date_from));
    printf("Sollte 29 sein : %i\n", _days_from_to(date_to,date_from));
    /*printf("Sollte 73 sein : %i\n", _days_from_to(12,12,2018,30,9,2018));
    printf("Sollte 179 sein : %i\n", _days_from_to(4,4,2018,30,9,2018));
    printf("Sollte 365 sein : %i\n", _days_from_to(4,4,2018,4,4,2019));
    printf("Sollte 365 sein : %i\n", _days_from_to(4,4,2019,4,4,2018));
    printf("Sollte 6603 sein : %i\n", _days_from_to(1,9,2000,30,9,2018));
    printf("Sollte 6545 sein : %i\n", _days_from_to(1,9,2018,30,9,2000));*/
    //printf("%i\n",week_day(16,9,2019));
